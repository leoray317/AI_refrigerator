...
class Yolo4(object):
    ...
    def detect_image(self, image, model_image_size=(608, 608)):
        ...
        print(end - start)
        temp_list = list()
        temp_list.append(label_list)
        temp_list.append(image)
        return temp_list

if __name__ == '__main__':
    model_path = 'yolo_obj_weights.h5'
    anchors_path = 'model_data/yolo4_anchors.txt'
    classes_path = 'model_data/obj_classes.txt'
    ...
    while True:
        ...
        try:
            ...
            print(f"this is result: {result[0]}")
            plt.imshow(result[1])
            plt.show()
